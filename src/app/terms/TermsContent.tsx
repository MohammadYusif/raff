            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4 text-raff-neutral-700">
                  ...
                  <ul className="list-inside list-disc space-y-2 ps-4">
                    <li>
                      <strong>{t("purchases.redirect")}</strong>:{" "}
                      {t("purchases.redirectDesc")}
                    </li>
                    <li>
                      <strong>{t("purchases.merchant")}</strong>:{" "}
                      {t("purchases.merchantDesc")}
                    </li>
                    <li>
                      <strong>{t("purchases.payment")}</strong>:{" "}
                      {t("purchases.paymentDesc")}
                    </li>
                    <li>
                      <strong>{t("purchases.returns")}</strong>:{" "}
                      {t("purchases.returnsDesc")}
                    </li>
                  </ul>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4 text-raff-neutral-700">
                  ...
                  <ul className="list-inside list-disc space-y-2 ps-4">
                    <li>
                      <strong>{t("commissions.tracking")}</strong>:{" "}
                      {t("commissions.trackingDesc")}
                    </li>
                    <li>
                      <strong>{t("commissions.calculation")}</strong>:{" "}
                      {t("commissions.calculationDesc")}
                    </li>
                    <li>
                      <strong>{t("commissions.payment")}</strong>:{" "}
                      {t("commissions.paymentDesc")}
                    </li>
                    <li>
                      <strong>{t("commissions.disputes")}</strong>:{" "}
                      {t("commissions.disputesDesc")}
                    </li>
                  </ul>
                </div>
              </CardContent>
