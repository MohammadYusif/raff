        ...
        <Card className="border-raff-neutral-200">
          <CardContent className="p-8">
            ...
            <div className="mb-8 text-center">
              ...
              {/* Title Skeleton */}
              <Skeleton variant="shimmer" className="mx-auto mb-2 h-8 w-48" />
              {/* Subtitle Skeleton */}
            ...
            <div className="space-y-4">
              ...
              {/* Email Field */}
              <div>
                <Skeleton variant="shimmer" className="mb-2 h-5 w-28" />
                <Skeleton variant="shimmer" className="h-10 w-full" />
              </div>
              ...
              <div>
                <Skeleton variant="shimmer" className="mb-2 h-5 w-32" />
                <Skeleton variant="shimmer" className="h-10 w-full" />
              </div>
